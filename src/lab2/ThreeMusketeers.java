...
public class ThreeMusketeers {
    ...
    private void undoMove() {
    	Move unmove = moves.remove(moves.size() - 1);
    	board.undoMove(unmove);
    }

//    private String getMoveInput() {
//    	System.out.print(isHumansPlaying());
//    	System.out.printf("[%s] Possible pieces are [E1, C3, A5]. Enter the piece you want to move: ", board.getTurn().getType());
//    	while(!scanner.hasNext("E1")&&scanner.hasNext("C3")&&scanner.hasNext("A5")&&scanner.hasNext("e1")&&scanner.hasNext("c3")&&scanner.hasNext("a5")) {
//    		System.out.printf(" %s is invalid", scanner.next());
//            scanner.next();
//    	}
